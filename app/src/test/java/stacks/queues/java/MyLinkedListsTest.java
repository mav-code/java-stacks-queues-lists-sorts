...
public class MyLinkedListsTest {
    ...
    public void getFirstItemFromLinkedList(){
        ...
        linkedList.add(3);
        linkedList.add(7);
        assertEquals(5, linkedList.getFirst().data, "Node added to linkedlist has correct value");
    }
    ...
    public void getLastItemFromLinkedList(){
         ...
         linkedList.add(3);
         linkedList.add(7);
         assertEquals(7, linkedList.getLast().data, "getLast gets last node in linked list");
    }
    ...
    public void getNumberByIndexFromLinkedList() {
        ...
        linkedList.add(3);
        linkedList.add(7);
        assertEquals(3, linkedList.get(1).data, "get value of first index in linked list");
    }
